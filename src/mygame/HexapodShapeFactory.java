...
public final class HexapodShapeFactory {
    
    public static CollisionShape createBaseShape() {
    ...
    public static CollisionShape createShoulderShape() {
    ...
    public static CollisionShape createArmShape() {
    ...
    public static CollisionShape createHandShape() {
